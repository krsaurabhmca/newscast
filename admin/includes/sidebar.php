...
<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="post_add.php" class="<?php echo $current_page == 'post_add.php' ? 'active' : ''; ?>">
        ...
        <li>
            <a href="epapers.php" class="<?php echo $current_page == 'epapers.php' ? 'active' : ''; ?>">
                <i data-feather="file-text" style="width: 20px; height: 20px; margin-right: 12px;"></i>
                Manage E-Paper
            </a>
        </li>
        <li>
            <a href="ads.php" class="<?php echo $current_page == 'ads.php' ? 'active' : ''; ?>">
                <i data-feather="image" style="width: 20px; height: 20px; margin-right: 12px;"></i>
                Manage Ads
            </a>
        </li>
        <li>
        ...
        <li style="margin-top: 20px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 20px;">
            <a href="<?php echo BASE_URL; ?>logout.php" style="color: #f87171;">
