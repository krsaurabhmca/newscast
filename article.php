...
<main class="content-container">
    <div class="article-layout">
        <article class="article-page">
            <div style="margin-bottom: 25px;">
                <?php if ($post['external_label'] != 'none'): ?>
                    <span
                        style="background: #000; color: #fff; padding: 3px 10px; border-radius: 4px; font-size: 11px; font-weight: 800; text-transform: uppercase; margin-bottom: 10px; display: inline-block;"><?php echo $post['external_label']; ?></span>
                    <?php
                endif; ?>
                ...
                <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 10px;">
                    <?php foreach ($post_categories as $cat): ?>
                        <a href="<?php echo BASE_URL; ?>category/<?php echo $cat['slug']; ?>"
                            style="color: <?php echo $cat['color']; ?>; font-weight: 700; font-size: 14px; text-transform: uppercase; background: <?php echo $cat['color']; ?>15; padding: 2px 8px; border-radius: 4px;"><?php echo $cat['name']; ?></a>
                        <?php
                    endforeach; ?>
                </div>

                <h1 style="margin-top: 10px; font-size: 38px; line-height: 1.2; font-weight: 800;">
                    <?php echo $post['title']; ?>
                </h1>

                <div class="article-meta-bar"
                    style="display: flex; align-items: center; justify-content: space-between; gap: 15px; margin-top: 20px; border-top: 1px solid #eee; border-bottom: 1px solid #eee; padding: 15px 0; flex-wrap: wrap;">
                    <div
                        style="font-size: 14px; color: #555; display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                        ...
                        <span style="display: flex; align-items: center; gap: 4px; color: #64748b; font-weight: 600;"
                            ...
                            <i data-feather="eye" style="width: 14px;"></i> <?php echo number_format($post['views']); ?>
                            views
                        </span>
                        <span style="color: #cbd5e1;">|</span>
                        <span style="display: flex; align-items: center; gap: 4px; color: #64748b; font-weight: 600;"
                        ...
                        <?php if (is_logged_in() && is_editor() && can_edit_post($post)): ?>
                            ...
                            <a href="<?php echo BASE_URL; ?>admin/post_edit.php?id=<?php echo $post['id']; ?>"
                                class="btn-edit-post-inline"
                                style="display: inline-flex; align-items: center; gap: 5px; background: rgba(248, 153, 29, 0.1); color: var(--primary); padding: 3px 10px; border-radius: 6px; font-size: 13px; font-weight: 700; transition: all 0.2s; text-decoration: none;"
                                onmouseover="this.style.background='var(--primary)'; this.style.color='#fff';"
                                onmouseout="this.style.background='rgba(248, 153, 29, 0.1)'; this.style.color='var(--primary)';">
                    ...
                    <div class="share-buttons-container"
                        ...
                        <!-- Share Buttons -->
                        <a href="https://api.whatsapp.com/send?text=<?php echo $share_title; ?>%20<?php echo $current_url; ?>"
                            target="_blank"
                            style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(37, 211, 102, 0.1); color: #25d366; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                            onmouseover="this.style.background='#25d366'; this.style.color='#fff'; this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(37,211,102,0.3)';"
                            onmouseout="this.style.background='rgba(37, 211, 102, 0.1)'; this.style.color='#25d366'; this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='none';"
                        ...
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $current_url; ?>"
                            target="_blank"
                            style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(24, 119, 242, 0.1); color: #1877f2; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                            onmouseover="this.style.background='#1877f2'; this.style.color='#fff'; this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(24,119,242,0.3)';"
                            onmouseout="this.style.background='rgba(24, 119, 242, 0.1)'; this.style.color='#1877f2'; this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='none';"
                        ...
                        <a href="https://twitter.com/intent/tweet?text=<?php echo $share_title; ?>&url=<?php echo $current_url; ?>"
                            target="_blank"
                            style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(15, 20, 25, 0.1); color: #0f1419; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                            onmouseover="this.style.background='#0f1419'; this.style.color='#fff'; this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(15,20,25,0.3)';"
                            onmouseout="this.style.background='rgba(15, 20, 25, 0.1)'; this.style.color='#0f1419'; this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='none';"
                            title="Share on X">
                        ...
                        <a href="javascript:void(0)"
                            onclick="navigator.share({title: '<?php echo addslashes($post['title']); ?>', url: window.location.href})"
                            style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(99, 102, 241, 0.1); color: #6366f1; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                            onmouseover="this.style.background='#6366f1'; this.style.color='#fff'; this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(99,102,241,0.3)';"
                            onmouseout="this.style.background='rgba(99, 102, 241, 0.1)'; this.style.color='#6366f1'; this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='none';"
                        ...
                        <a href="javascript:void(0)" onclick="downloadEPaper()"
                            style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: rgba(15, 23, 42, 0.1); color: #0f172a; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                            onmouseover="this.style.background='#0f172a'; this.style.color='#fff'; this.style.transform='scale(1.1) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(15,23,42,0.3)';"
                            onmouseout="this.style.background='rgba(15, 23, 42, 0.1)'; this.style.color='#0f172a'; this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='none';"
                            title="Download as E-Paper (Image)">
                ...
                <div class="utility-card"
                    style="margin-top: 15px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; background: var(--primary); padding: 15px 20px; border-radius: 14px; border: 1px solid rgba(255,255,255,0.1); box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                    onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 12px 25px rgba(0,0,0,0.15)';"
                    onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.1)';">
                    <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                        <?php if (get_setting('tts_enabled', 'yes') == 'yes'): ?>
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <button id="tts-btn" onclick="toggleVoice()" class="btn"
                                    style="padding: 6px 14px; font-size: 13px; background: #ffffff; border: none; display: flex; align-items: center; gap: 8px; font-weight: 800; color: var(--primary); border-radius: 8px; transition: all 0.3s ease; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"
                                    onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.15)';"
                                    onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
                                    <i data-feather="play" id="tts-icon" style="width: 14px;"></i> <span
                                        id="tts-text">Listen Article</span>
                                </button>
                            </div>
                        <?php endif; ?>

                        <?php if (get_setting('tts_enabled', 'yes') == 'yes' && get_setting('translation_enabled', 'no') == 'yes'): ?>
                            <div style="border-left: 2px solid rgba(255,255,255,0.3); height: 20px; border-radius: 2px;">
                            </div>
                        <?php endif; ?>

                        <?php if (get_setting('translation_enabled', 'no') == 'yes'): ?>
                            <div id="google_translate_element"></div>
                            <button onclick="resetLanguage()" title="Reset to Original Language"
                                style="padding: 6px 12px; font-size: 13px; font-weight: 800; background: #ffffff; border: none; border-radius: 8px; cursor: pointer; color: var(--primary); display: flex; align-items: center; gap: 6px; transition: all 0.3s ease; box-shadow: 0 4px 6px rgba(0,0,0,0.1);"
                                onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.15)';"
                                onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';">
                    ...
                    if ($fb_url || $tw_url || $ig_url || $yt_url):
                        ...
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <span
                                style="font-size: 13px; font-weight: 800; color: #ffffff; text-transform: uppercase; letter-spacing: 0.5px;">Follow:</span>
                            <?php if ($fb_url): ?>
                                <a href="<?php echo htmlspecialchars($fb_url); ?>" target="_blank"
                                    style="color: #1877F2; background: #ffffff; padding: 8px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: none; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                                    onmouseover="this.style.transform='scale(1.15) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.2)';"
                                    onmouseout="this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';"
                                    title="Follow on Facebook">
                                    <i data-feather="facebook" style="width: 16px; height: 16px;"></i>
                                </a>
                            <?php endif; ?>
                            <?php if ($tw_url): ?>
                                <a href="<?php echo htmlspecialchars($tw_url); ?>" target="_blank"
                                    style="color: #0f1419; background: #ffffff; padding: 8px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: none; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                                    onmouseover="this.style.transform='scale(1.15) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.2)';"
                                    onmouseout="this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';"
                                    title="Follow on X">
                            ...
                            <?php endif; ?>
                            <?php if ($ig_url): ?>
                                <a href="<?php echo htmlspecialchars($ig_url); ?>" target="_blank"
                                    style="color: #E1306C; background: #ffffff; padding: 8px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: none; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                                    onmouseover="this.style.transform='scale(1.15) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.2)';"
                                    onmouseout="this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';"
                            ...
                            <?php if ($yt_url): ?>
                                <a href="<?php echo htmlspecialchars($yt_url); ?>" target="_blank"
                                    style="color: #FF0000; background: #ffffff; padding: 8px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border: none; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);"
                                    onmouseover="this.style.transform='scale(1.15) translateY(-2px)'; this.style.boxShadow='0 6px 12px rgba(0,0,0,0.2)';"
                                    onmouseout="this.style.transform='scale(1) translateY(0)'; this.style.boxShadow='0 4px 6px rgba(0,0,0,0.1)';"
            ...
            <?php if ($post['video_url']): ?>
                <div
                    style="margin-bottom: 25px; aspect-ratio: 16/9; width: 100%; background: #000; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                    <?php
                    $video_id = extract_youtube_id($post['video_url']);
                    if ($video_id):
                        ?>
                        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?php echo $video_id; ?>"
            ...
            elseif ($post['featured_image']): ?>
                <img src="<?php echo get_post_thumbnail($post['featured_image']); ?>" alt="<?php echo $post['title']; ?>"
            ...
            <?php if (get_setting('likes_dislikes_enabled', 'no') == 'yes'): ?>
                ...
                <div class="ratings-container"
                    style="display: flex; align-items: center; gap: 20px; margin-top: 30px; padding: 15px 25px; background: #f8fafc; border-radius: 12px; border: 1px solid #e2e8f0; max-width: max-content;">
                    <span style="font-size: 14px; font-weight: 700; color: #475569;">Rate this article:</span>
                    <div style="display: flex; gap: 10px;">
                        <button type="button" class="rating-btn like-btn"
                            onclick="rateArticle(<?php echo $post['id']; ?>, 'like')"
                            style="display: flex; align-items: center; gap: 8px; border: 1px solid #cbd5e1; background: white; padding: 8px 16px; border-radius: 8px; font-size: 14px; font-weight: 700; color: #1e293b; cursor: pointer; transition: 0.2s;"
                        ...
                        <button type="button" class="rating-btn dislike-btn"
                            onclick="rateArticle(<?php echo $post['id']; ?>, 'dislike')"
                            style="display: flex; align-items: center; gap: 8px; border: 1px solid #cbd5e1; background: white; padding: 8px 16px; border-radius: 8px; font-size: 14px; font-weight: 700; color: #1e293b; cursor: pointer; transition: 0.2s;"
                            onmouseover="this.style.borderColor='var(--primary)'"
                            onmouseout="this.style.borderColor='#cbd5e1'">
                    ...
                    <span id="rating-status"
                        style="font-size: 13px; font-weight: 600; color: #64748b; display: none;"></span>
                </div>
            <?php endif; ?>
            ...
            <?php if (get_setting('comments_enabled', 'no') == 'yes'):
                ...
                <div class="comments-section" style="margin-top: 50px; border-top: 2px solid #e2e8f0; padding-top: 40px;">
                    <h3
                        style="font-size: 16px; font-weight: 800; margin-bottom: 25px; color: var(--primary); text-transform: uppercase; letter-spacing: .06em; display:flex; align-items:center; gap:8px;">
                        <span
                            style="display:inline-block;width:3px;height:18px;background:var(--primary);border-radius:2px;"></span>
                        Comments (<?php echo count($post_comments); ?>)
                    </h3>

                    <!-- Comment Submission Form -->
                    <div
                        style="background: white; padding: 25px; border-radius: 16px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px rgba(0,0,0,0.02); margin-bottom: 35px;">
                        <h4 style="font-size: 15px; font-weight: 700; color: #0f172a; margin-top:0; margin-bottom:15px;">
                            Leave a Comment</h4>
                        <form id="comment-form" onsubmit="submitComment(event, <?php echo $post['id']; ?>)">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                                <div>
                                    <label
                                        style="display: block; font-size: 12px; font-weight: 700; color: #475569; margin-bottom: 6px;">Your
                                        Name</label>
                                    <input type="text" name="name" required placeholder="John Doe"
                                        style="width: 100%; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none; border-color:#cbd5e1;"
                                        onfocus="this.style.borderColor='var(--primary)'"
                                        onblur="this.style.borderColor='#cbd5e1'">
                                </div>
                                <div>
                                    <label
                                        style="display: block; font-size: 12px; font-weight: 700; color: #475569; margin-bottom: 6px;">Email
                                        Address</label>
                            ...
                            <div style="margin-bottom: 15px;">
                                <label
                                    style="display: block; font-size: 12px; font-weight: 700; color: #475569; margin-bottom: 6px;">Comment</label>
                                <textarea name="comment" rows="4" required placeholder="Share your thoughts..."
                                    style="width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14px; outline: none; font-family:inherit; resize: vertical; border-color:#cbd5e1;"
                                    onfocus="this.style.borderColor='var(--primary)'"
                            ...
                            <div
                                ...
                                <button type="submit"
                                    style="background: var(--primary); color: white; border: none; padding: 10px 24px; border-radius: 8px; font-weight: 700; font-size: 14px; cursor: pointer; transition: 0.2s;"
                                    onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">Post
                                    Comment</button>
                                <span id="comment-status"
                                    style="font-size: 13px; font-weight: 600; color: #10b981; display:none;"></span>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="comments-list" style="display: flex; flex-direction: column; gap: 20px;">
                        <?php if (empty($post_comments)): ?>
                            <div
                                style="text-align: center; padding: 30px; background: #f8fafc; border-radius: 12px; border: 1px dashed #cbd5e1; color: #64748b; font-weight: 500;">
                                No comments yet. Be the first to share your thoughts!
                            </div>
                        <?php else: ?>
                            <?php foreach ($post_comments as $cmt): ?>
                                <div
                                    style="background: #f8fafc; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; display:flex; gap:15px;">
                                    <div
                                        style="background: var(--primary); color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 16px; flex-shrink: 0;">
                                        <?php echo strtoupper(substr($cmt['user_name'], 0, 1)); ?>
                                    </div>
                                    <div>
                                        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 5px;">
                                            <span
                                                style="font-weight: 700; color: #1e293b; font-size: 14px;"><?php echo htmlspecialchars($cmt['user_name']); ?></span>
                                            <span
                                                style="font-size: 12px; color: #94a3b8; font-weight: 500;"><?php echo format_date($cmt['created_at']); ?></span>
                                        </div>
            ...
            <div style="margin-top: 60px; padding-top: 40px; border-top: 2px solid #e2e8f0;">
                <h3
                    style="font-size: 16px; font-weight: 800; margin-bottom: 20px; color: var(--primary); text-transform: uppercase; letter-spacing: .06em; display:flex; align-items:center; gap:8px;">
                    <span
                        style="display:inline-block;width:3px;height:18px;background:var(--primary);border-radius:2px;"></span>
                    Related Stories
                </h3>
                    ...
                    <?php foreach ($related as $r): ?>
                        <article class="news-card">
                            <a href="<?php echo BASE_URL; ?>article/<?php echo $r['slug']; ?>">
                                <img src="<?php echo get_post_thumbnail($r['featured_image']); ?>" alt=""
                                    style="height: 140px;">
        ...
        <div id="epaper-template"
            style="display: none; padding: 30px; background: #fff; width: 800px; box-sizing: border-box; color: #000; font-family: 'Times New Roman', Times, serif; margin: 0; position: relative; left: 0; top: 0;">
            <!-- Header -->
            <div
                style="border-bottom: 4px solid #000; padding-bottom: 20px; margin-bottom: 30px; display: flex; justify-content: space-between; align-items: flex-end;">
                <div>
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <?php if (get_setting('site_logo')): ?>
                            <img src="<?php echo BASE_URL . 'assets/images/' . get_setting('site_logo'); ?>"
                                style="height: 60px;" alt="<?php echo SITE_NAME_DYNAMIC; ?>">
                        <?php endif; ?>
                        <h1
                            style="margin: 0; font-size: 36px; text-transform: uppercase; letter-spacing: 2px; font-weight: 900; line-height: 1;">
                            <?php echo SITE_NAME_DYNAMIC; ?>
                        </h1>
                    </div>
                    <p style="margin: 5px 0 0; font-size: 14px; font-weight: bold; text-transform: uppercase;">E-Paper
                        Edition</p>
                    <?php if ($primary_cat): ?>
                        <p
                            style="margin: 5px 0 0; font-size: 13px; font-weight: bold; color: #ff3c00; text-transform: uppercase; letter-spacing: 1px;">
                            <?php echo htmlspecialchars($primary_cat['name']); ?>
                        </p>
                    <?php endif; ?>
                </div>
                <div style="text-align: right; font-size: 14px;">
                    <p style="margin: 0;"><strong>Published:</strong> <?php echo format_date($post['created_at']); ?>
                    </p>
            ...
            <!-- Article Title -->
            <h1 style="font-size: 42px; line-height: 1.1; margin: 0 0 20px 0; font-weight: bold; text-align: center;">
                <?php echo $post['title']; ?>
            </h1>
            ...
            if ($epaper_ad):
                ...
                <div style="margin-top: 30px; border-top: 1px dashed #ccc; padding-top: 20px; page-break-inside: avoid;">
                    <div style="text-align: center; max-width: 100%;">
                        <h5
                            style="margin: 0 0 10px 0; font-size: 10px; color: #999; text-transform: uppercase; letter-spacing: 2px;">
                            Advertisement</h5>
                        <?php echo $epaper_ad; ?>
                    </div>
                </div>
            ...
            <!-- Footer & QR Code -->
            <div
                style="margin-top: 50px; border-top: 2px solid #000; padding-top: 20px; display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="text-align: center;">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php echo urlencode((isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>&margin=0"
                        alt="QR Code" style="border: 5px solid #fff; outline: 1px solid #ccc;">
        ...
        <aside class="article-sidebar">
            <div style="position: sticky; top: 20px; display: flex; flex-direction: column; gap: 30px;">
                ...
                if (!empty($wa_number) && !$hide_whatsapp_promo):
                    ...
                    <div
                        style="background: linear-gradient(135deg, #075e54, #128c7e); border-radius: 16px; padding: 25px; box-shadow: 0 10px 30px rgba(18,140,126,0.15); border: 1px solid rgba(255,255,255,0.1); color: white; text-align: center;">
                        <div
                        ...
                        <h4 style="font-size: 16px; font-weight: 800; margin: 0 0 10px 0; letter-spacing: 0.5px;">
                            <?php echo htmlspecialchars(get_setting('site_name', 'NewsCast')); ?> व्हाट्सएप न्यूज बॉट
                        </h4>
                        <ul
                            style="text-align: left; font-size: 13px; line-height: 1.6; font-weight: 500; color: rgba(255,255,255,0.9); margin: 0 0 20px 0; padding-left: 20px;">
                        ...
                        <a href="<?php echo $wa_url; ?>" target="_blank"
                            style="background: white; color: #075e54; text-decoration: none; padding: 12px 20px; border-radius: 8px; font-size: 14px; font-weight: 800; display: inline-flex; align-items: center; justify-content: center; width: 100%; gap: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: all 0.2s;"
                            ...
                            <i data-feather="message-square" style="width: 16px; height: 16px;"></i> चैट शुरू करें (Start
                            Chat)
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($active_poll): ?>
                    <div class="poll-widget"
                        ...
                        <h4
                            ...
                            <div
                                style="background: rgba(99, 102, 241, 0.1); padding: 6px; border-radius: 6px; color: #6366f1;">
                                <i data-feather="pie-chart" style="width: 16px;"></i>
                            </div>
                            Poll of the Day
                        </h4>
                        <div
                            style="font-size: 17px; font-weight: 700; color: #1e293b; margin-bottom: 20px; line-height: 1.4;">
                    ...
                    <div style="position: relative; padding-left: 20px;">
                        ...
                        if ($timeline_items):
                            ...
                            <div style="text-align: center; padding: 20px 0;">
                                ...
                                <p style="font-size: 14px; color: #94a3b8; font-weight: 500;">No events scheduled for today.
                                </p>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div>
                    <h4
                        style="border-bottom: 2px solid #333; padding-bottom: 5px; margin-bottom: 15px; font-size: 16px; font-weight: 800;">
                        TRENDING</h4>
                    <?php
                    $trending = $pdo->query("SELECT * FROM posts WHERE status = 'published' ORDER BY views DESC LIMIT 5")->fetchAll();
                    foreach ($trending as $tp):
                        ?>
                        <a href="<?php echo BASE_URL; ?>article/<?php echo $tp['slug']; ?>"
                            style="display: flex; gap: 10px; text-decoration: none; color: inherit; margin-bottom: 15px;">
