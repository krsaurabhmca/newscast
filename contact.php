...
$page_title = "Submit News / Article";
...
<div class="content-container" style="max-width: 1000px; padding: 50px 20px;">
    <h1 style="font-size: 36px; font-weight: 800; color: #0f172a; text-align: center; margin-bottom: 50px;">Submit News / Article</h1>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px;">
        ...
        <div>
            <div style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); height: 100%;">
                <h3 style="font-size: 24px; font-weight: 700; color: #1e293b; margin-bottom: 25px;">Submission Guidelines</h3>
                <p style="color: #64748b; margin-bottom: 30px; line-height: 1.6;">Have a breaking story, local updates, or investigative news? Submit them here. Our editors will review your submission and publish it once approved.</p>
                ...
                <div style="display: flex; gap: 20px; align-items: start; margin-bottom: 25px;">
                    ...
                    <div>
                        <h4 style="margin: 0; font-size: 16px; color: #1e293b;">Editorial Desk</h4>
                ...
                <div style="display: flex; gap: 20px; align-items: start; margin-bottom: 25px;">
                    ...
                    <div>
                        <h4 style="margin: 0; font-size: 16px; color: #1e293b;">Contact Support</h4>
                ...
                <div style="display: flex; gap: 20px; align-items: start;">
                    ...
                    <div>
                        <h4 style="margin: 0; font-size: 16px; color: #1e293b;">Office Address</h4>
        ...
        <div>
            <div style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
                <h3 style="font-size: 24px; font-weight: 700; color: #1e293b; margin-bottom: 25px;">Submit Your Draft</h3>
                
                <form id="contactPageForm" enctype="multipart/form-data">
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">Author Name <span style="color:red;">*</span></label>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">Email Address <span style="color:red;">*</span></label>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">Article Title <span style="color:red;">*</span></label>
                        <input type="text" name="subject" required style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 14px;" placeholder="Catchy title for the news...">
                    </div>
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">News Category <span style="color:red;">*</span></label>
                        <select name="category_id" required style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 14px; background: white;">
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">Featured Image / Cover Photo</label>
                        <input type="file" name="featured_image" accept="image/*" style="width: 100%; padding: 10px; border: 1.5px dashed #cbd5e1; border-radius: 10px; font-size: 13px;">
                    </div>
                    <div style="margin-bottom: 25px;">
                        <label style="display: block; font-size: 14px; font-weight: 700; color: #334155; margin-bottom: 8px;">Article Body / Content <span style="color:red;">*</span></label>
                        <textarea name="message" required style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 14px; min-height: 150px; resize: vertical;" placeholder="Write your news story in detail here..."></textarea>
                    </div>
...
document.getElementById('contactPageForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        submitBtn.innerText = 'Submit Draft for Approval';
    })
    .catch(err => {
        responseDiv.innerText = 'Network error: could not submit draft.';
        responseDiv.style.display = 'block';
